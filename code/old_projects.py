from request_api import request_api, next_page
import pandas as pd
import time
import os
...
def transfor_data(data, new_schema_project, schema_subitems):
    ...
    for items in data:
...
def format_data(df_project, df_subitems): 
    ...
    coluns_number_projects = ['cost', 'hours', 'working_days', 'advanced_onboarding', 'us$_monthly_consuption']
...
def old_projects():
    ...
    transfor_data(data, new_schema_project, schema_subitems)
